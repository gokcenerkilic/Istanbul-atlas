    ...
    <AnimatePresence>
      {isOpen && (
        <motion.div
          ...
          className="absolute right-6 top-6 bottom-6 w-96 z-40"
        >
          <Card className="h-full bg-white/95 backdrop-blur-sm shadow-2xl border-0 flex flex-col">
            <CardHeader className="border-b border-gray-200 bg-cyan-600 text-white rounded-t-lg flex-shrink-0">
